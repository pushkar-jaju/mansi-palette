          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                autoComplete="email"
                spellCheck={false}
                placeholder="e.g. mansi@example.com…"
            ...
            <button
              type="submit"
              disabled={isPending}
              className="mt-2 w-full py-2.5 rounded-sm bg-primary hover:bg-primary-hover border border-primary-focus text-primary-foreground text-xs font-semibold transition-all flex items-center justify-center gap-2 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isPending ? (
                <>
